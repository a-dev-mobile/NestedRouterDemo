...
/// {@template AppSectionedListView}
/// A App Sectioned List view.
///
/// ```dart
/// AppSectionedListView(
///   sections: sections,
///   itemBuilder: (context, item) => item,
/// )
/// ```
/// {@endtemplate}
class AppSectionedListView<T> extends StatelessWidget {
  ///
  const AppSectionedListView({
  ...
  Widget build(BuildContext context) {
    ...
    Widget? titleAndItemBuilder(BuildContext context, int i) =>
        flattened[i] is _SectionHeading
...
/// {@template Section}
/// A App utility class to define a section in the list view.
///
/// ```dart
/// Section.withHeading(
///   Text('Heading'),
...
class Section<T> {
  ...
  Widget? get _header {
    return _heading ?? _asListTile(_DefaultSectionHeading.text(label!));
  }
